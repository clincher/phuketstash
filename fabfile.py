"""
Starter fabfile for deploying the stash project.
...
# CHANGEME
env.hosts = ['user@stash.example.com']
env.code_dir = '/srv/www/stash'
env.project_dir = '/srv/www/stash/stash'
env.static_root = '/srv/www/stash/static/'
env.virtualenv = '/srv/www/stash/.virtualenv'
env.code_repo = 'git@github.com:user/stash.git'
env.django_settings_module = 'stash.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/stash/wsgi.py" % env.code_dir)
