...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'visits_subscription', 'administrant',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='subscribers', to=orm['users.User']),
                      keep_default=False)

        # Adding field 'Payment.administrant'
        db.add_column(u'visits_payment', 'administrant',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='payments', to=orm['users.User']),
                      keep_default=False)

        # Adding field 'Visit.administrant'
        db.add_column(u'visits_visit', 'administrant',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='visitors', to=orm['users.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subscription.administrant'
        db.delete_column(u'visits_subscription', 'administrant_id')

        # Deleting field 'Payment.administrant'
        db.delete_column(u'visits_payment', 'administrant_id')

        # Deleting field 'Visit.administrant'
        db.delete_column(u'visits_visit', 'administrant_id')
    ...
    models = {
        ...
        u'visits.payment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pay_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 10, 0, 0)'}),
        ...
        u'visits.visit': {
            ...
            'arrival_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 10, 0, 0)'}),
