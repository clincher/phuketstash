...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Payment.value'
        db.alter_column(u'visits_payment', 'value', self.gf('django.db.models.fields.IntegerField')(null=True))
        # Adding M2M table for field pastimes on 'Visit'
        m2m_table_name = db.shorten_name(u'visits_visit_pastimes')
        ...
        db.create_unique(m2m_table_name, ['visit_id', 'pastime_id'])


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Payment.value'
        raise RuntimeError("Cannot reverse this migration. 'Payment.value' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Payment.value'
        db.alter_column(u'visits_payment', 'value', self.gf('django.db.models.fields.IntegerField')())
        # Removing M2M table for field pastimes on 'Visit'
        db.delete_table(db.shorten_name(u'visits_visit_pastimes'))
